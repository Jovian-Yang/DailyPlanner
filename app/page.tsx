...
function BrandIntro() {
  return <section className="brand-intro-card" aria-label="About Daily Planner"><div className="brand-intro-art"><img src="/daily-planner-logo.png" alt="Daily Planner logo" /></div><div className="brand-intro-copy"><span className="eyebrow">DAILY PLANNER</span><h3>Make room for what matters.</h3><p>A quiet, local-first place for the plans you want to keep close.</p></div></section>;
}
